...
cr.define('tracing', function() {
  ...
  Timeline.prototype = {
    ...
    decorate: function() {
      ...
      this.tracks_.classList.add('thread-list');
    ...
    set model(model) {
      ...
      //Reset ruler to prevent multiple occurences
      var ruler = this.getElementsByClassName('timeline-viewport-track')[0];
      //Check if ruler exists
      if (typeof(ruler) !== 'undefined') {
        //get rid of existing ruler
        ruler.detatch();
      }
      ...
      // prepend ruler
      this.insertBefore(viewportTrack, this.firstChild);
